...
<head>
    ...
    <title>PkCEP 2025 - Conference Agenda</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <article class="agenda-section">
            ...
            <div class="session-content">
                ...
                <!-- <div class="speaker-bio">
                    ...
                    <div class="panelist-card">
                        <h4>Rabia Sirhindi</h4>
                        <div class="affiliation">Details to be provided</div>
                        <p>Panel moderator with expertise in computing education and AI integration in educational contexts.</p>
                    </div>
                </div> -->
            </div>
        </article>
